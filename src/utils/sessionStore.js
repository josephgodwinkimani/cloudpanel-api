...
class SessionStore {
  ...
  async initialize() {
    try {
      ...
      logger.warn('Failed to initialize Redis store, falling back to memory store:', error.message);
      this.initializeMemoryStore();
    }
  }
  ...
  initializeMemoryStore() {
    ...
    if (process.env.NODE_ENV === 'production') {
      logger.warn('WARNING: Using MemoryStore in production is not recommended. Consider setting up Redis.');
